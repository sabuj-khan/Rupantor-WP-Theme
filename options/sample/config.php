...
$opt_name = 'sabujcomet';  // YOU MUST CHANGE THIS.  DO NOT USE 'redux_demo' IN YOUR PROJECT!!!
...
Redux::set_section(
	...
	array(
		...
		'id'               => 'general',
		'desc'             => 'These are the general options.',
...
Redux::set_section($opt_name,array(
		...
		'desc'             => 'All uploading options are here',
		'fields'           => array(
			array(
				'id'       => 'light-logo',
				'type'     => 'media',
				'title'    => 'Light Logo Upload',
				'subtitle' => 'Light logo upload',
				'desc'     => 'Upload your light logo here',				
			),
			array(
				'id'       => 'dark-logo',
				'type'     => 'media',
				'title'    => 'Dark Logo Upload',
				'subtitle' => 'Dark logo upload',
				'desc'     => 'Upload your dark logo here',				
			),
			...
			array(
				...
				'type'     => 'media',
				'title'    => 'Blog Image ',
				'subtitle' => 'Blog Image upload',
				'desc'     => 'Upload your blog image here',				
			),
			...
			array(
				...
				'type'     => 'text',
				'title'    => 'Blog Title',
				'subtitle' => 'Blog title is here',
				'desc'     => 'Put your blog title is here',				
			),
		...
		array(
				...
				'subtitle' => 'Blog subtitle is here',
				'desc'     => 'Write your blog subtitle is here',				
			),
...
Redux::set_section($opt_name,array(
		...
		'subsection'       => true,
		'customizer_width' => '450px',
		'desc'             => 'All footer options are here',
		'fields'           => array(
			array(
				'id'       => 'footer-copy',
				'type'     => 'text',
				'title'    => 'Footer Copyright',
				'subtitle' => 'Footer Copyright is here',
				'desc'     => 'Type your Footer Copyright text is here',				
			)),
...
Redux::set_section(
	...
	array(
		'title'            => 'Blog Options',
		'id'               => 'blog-fields',
		'desc'             => 'These are the Blog options.',
		'customizer_width' => '400px',
		'icon'             => 'el el-edit',
	)
);
...
Redux::set_section($opt_name,array(
		...
		'subsection'       => true,
		'customizer_width' => '450px',
		'desc'             => 'All blog options are here',
		'fields'           => array(
			array(
			...
			array(
				...
				'desc'     => 'Blog header would be are here',							
			),
			array(
				'id'       => 'blog-header-subtitle',
				'type'     => 'text',
				'title'    => 'Blog Header Sub Title',
				'desc'     => 'Blog header sub title would be are here',							
			),
			),
