...
function my_theme_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			'name'               => 'Redux hghg Framework', // The plugin name.
			'slug'               => 'redux-framework', // The plugin slug (typically the folder name).
			 // The plugin source.
			'source'			 =>	get_stylesheet_directory().'/plugins/redux-framework.zip',
...
add_action('vc_before_init', 'vc_theme_function');

function vc_theme_function(){
	vc_set_as_theme();
}
